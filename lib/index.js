...
const OpListProto = protobuf.loadSync(path.join(__dirname, '../protobuf/op_def.proto')).lookupType('OpList');
// load modules
 ...
 */
 ...
 tensorflow.getAllOpList = () => {
   const opList = OpListProto.decode(tensorflow.GetAllOpList());
   return opList.op;
 }